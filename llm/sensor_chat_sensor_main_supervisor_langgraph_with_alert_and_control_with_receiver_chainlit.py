...
# # Example usage
# delete_all_rule_chains(
#     base_url=THINGSBOARD_URL,
#     username=USERNAME,
#     password=PASSWORD
# )
...
#     prompt="You are an alert assistant. Given a natural language query, extract the sensor name using `sensor_tool` and threshold value from the query. Then run the `run_alert_script` tool with those arguments. To delete alert use the `delete_all_rule_chains` to do so",
#     name="alert_agent"
# )
