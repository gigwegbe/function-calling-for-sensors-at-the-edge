...
result = top_supervisor.invoke({
    "messages": [
        {
            "role": "user",
             "content": "What is the weather in  Nyagatare District, Eastern Province, Rwanda"
            # "content": "Get all sensors in the South Field and the South-West Field"
        }
    ]
})
...
# print(result)
# Invoke it
# response = weather_agent_node.invoke("What is the weather in Kigali, Rwanda today?")
# response = workflow.invoke({"input": "What is the weather in Kigali, Rwanda today?"})
# print(response)