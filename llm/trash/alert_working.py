...
def build_rule_chain_metadata(rule_chain_id, sensor_field, threshold_value):
    print("--- Building Rule Chain Metadata ---")
    print(f"Rule Chain ID: {rule_chain_id}")
    print(f"Sensor Field: {sensor_field}")
    print(f"Threshold Value: {threshold_value}")

    js_filter_script = f"return msg.{sensor_field} > {threshold_value};"
    print(f"Generated Filter Script: {js_filter_script}")
    ...
    print("Nodes configuration created.")

    connections = [
        {"fromIndex": 0, "toIndex": 1, "type": "True"},
        {"fromIndex": 0, "toIndex": 2, "type": "False"}
    ]
    print("Connections configuration created.")
    ...
    print("Final metadata dictionary created.")
    print(f"Metadata: {metadata}")
    print("--- Rule Chain Metadata Building Complete ---")
