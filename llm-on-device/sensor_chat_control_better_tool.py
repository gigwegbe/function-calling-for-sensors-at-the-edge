...
def build_control_extraction_tool(model, prompt_template) -> Runnable:
    ...
    def control_extraction(input: str) -> dict:
        ...
        # Try to parse JSON directly from response content
        try:
            if hasattr(response, 'content'):  # langchain_core.messages.AIMessage
...
runnable = create_openai_fn_runnable([ActutatorExtraction], model, prompt_control_template)
...
control_extraction_agent = create_react_agent(
    model=model,
    tools=[control_extraction, control_actuator],
    prompt=(
...
# Turn on South field fertilizer dispenser.
# ================================== Ai Message ==================================
# Name: control_extraction_agent
# Tool Calls:
#   control_extraction (call_YeRm3TatVJXuAhhSfyINZSWa)
#  Call ID: call_YeRm3TatVJXuAhhSfyINZSWa
#   Args:
#     input: South field fertilizer dispenser
# ================================= Tool Message =================================
# Name: control_extraction

# actuator_id=['PUMP-0501', 'FD-0500']
# ================================== Ai Message ==================================
# Name: control_extraction_agent
# Tool Calls:
#   control_actuator (call_hIjOT5FsG17WEgo0E7lYQpWY)
#  Call ID: call_hIjOT5FsG17WEgo0E7lYQpWY
#   Args:
#     device_name: PUMP-0501
#     device_state: 1
#   control_actuator (call_046jc4hEj1dpTNaWFo2JZZE9)
#  Call ID: call_046jc4hEj1dpTNaWFo2JZZE9
#   Args:
#     device_name: FD-0500
#     device_state: 1
# ================================= Tool Message =================================
...
# Successfully set state of 'PUMP-0501' to ON.
# ================================= Tool Message =================================
# Name: control_actuator

# Successfully set state of 'FD-0500' to ON.
# ================================== Ai Message ==================================
# Name: control_extraction_agent

# {"actuator_ids": ["PUMP-0501", "FD-0500"]}
...
# Name: control_extraction_agent
# Tool Calls:
#   control_actuator (7a8dd757-5450-4c87-bd6d-1f3cf8c606fa)
#  Call ID: 7a8dd757-5450-4c87-bd6d-1f3cf8c606fa
#   Args:
#     device_name: South field fertilizer dispenser
#     device_state: 1
# ================================= Tool Message =================================
# Name: control_actuator

# Error while controlling actuator 'South field fertilizer dispenser': Device South field fertilizer dispenser not found. Status: 404
# ================================== Ai Message ==================================
# Name: control_extraction_agent
# Tool Calls:
#   control_actuator (cde31359-fce2-421b-8022-7a115c885b39)
#  Call ID: cde31359-fce2-421b-8022-7a115c885b39
#   Args:
#     device_name: FD-0300
#     device_state: 1
# ================================= Tool Message =================================
...
# Successfully set state of 'FD-0300' to ON.
# ================================== Ai Message ==================================
# Name: control_extraction_agent

# {"actuator_ids": ["FD-0300"]}