...
def build_rule_chain_metadata(rule_chain_id, sensor_name, sensor_field, threshold_value):
    # js_filter_script = f"return msg.sen{sensor_field} > {threshold_value};"
...
# def build_rule_chain_metadata(rule_chain_id, sensor_field, threshold_value, temp_key, target_sensor_name):
#     """Builds metadata for a rule chain that filters by sensor name."""
#     js_filter_script = f"return msg.sensorName === '{target_sensor_name}' && msg.{temp_key} > {threshold_value};"

#     nodes = [
#         {
#             "type": "org.thingsboard.rule.engine.filter.TbJsFilterNode",
#             "name": f"{sensor_field.capitalize()} Filter for {target_sensor_name}",
#             "configuration": {
#                 "jsScript": js_filter_script
#             },
#             "additionalInfo": {
#                 "layoutX": 260,
#                 "layoutY": 151,
#                 "description": f"Checks if sensorName is '{target_sensor_name}' and {sensor_field} ({temp_key}) exceeds {threshold_value}"
#             }
#         },
#         {
#             "type": "org.thingsboard.rule.engine.action.TbCreateAlarmNode",
#             "name": f"Create High {sensor_field.capitalize()} Alarm for {target_sensor_name}",
#             "configuration": {
#                 "alarmType": f"High {sensor_field.capitalize()}",
...
#                     delete metadata.prevAlarmDetails;
#                 }}
#                 details.sensorName = '{target_sensor_name}';
#                 details.temperatureKey = '{temp_key}';
#                 details.value = msg.{temp_key};
#                 return details;
#                 """,
#                 "severity": "CRITICAL",
#                 "propagate": True,
...
#         {
#             "type": "org.thingsboard.rule.engine.action.TbClearAlarmNode",
#             "name": f"Clear High {sensor_field.capitalize()} Alarm for {target_sensor_name}",
#             "configuration": {
#                 "alarmType": f"High {sensor_field.capitalize()}",
#                 "alarmDetailsBuildJs": json.dumps("return {};")[1:-1]
#             },
...
def main():
    ...
    sensor_name = input("Enter sensor name e.g TEMP-0100 ")
